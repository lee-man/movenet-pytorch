    ...
    for idx, layer in enumerate(layers):
        ...
        try:
            ...
            ### Add
                ...
                print(f'@@@@@@@@@ add layer_id:{layer_id} tf_layers_dict:{tf_layers_dict[layer_id]}')
            ...
            ### Concat
                ...
                # if layer_id == '421':
                #     print(f'@@@@@ concat layer_id:{layer_id} tf_layers_dict:{tf_layers_dict}')
            ...
            ### Multiply
                ...
                print(f'@@@@@ multiply layer_id:{layer_id} tf_layers_dict:{tf_layers_dict[layer_id]}')
            ...
            ### Convert
                ...
                print(f'@@@@@ convert layer_id:{layer_id} tf_layers_dict:{tf_layers_dict[layer_id]}')
            ...
            ### TopK
                ...
                print(f'@@@@@@@ layer_id_values: {tf_layers_dict[get_tf_edges_from(tf_edges, layer_id, 0)]}')
                print(f'@@@@@@@ layer_id_indices: {tf_layers_dict[get_tf_edges_from(tf_edges, layer_id, 1)]}')
                print(f'@@@@@@@ topk layer_id:{layer_id} tf_layers_dict:{tf_layers_dict[layer_id_values]}')
            ...
            ### Transpose
                ...
                print(f'@@@@@ transpose layer_id:{layer_id} tf_layers_dict:{tf_layers_dict[layer_id]}')
            ...
            ### Squeeze
                ...
                print(f'@@@@@@@ squeeze layer_id:{layer_id} tf_layers_dict:{tf_layers_dict[layer_id]}')
            ...
            ### Gather
                ...
                if layer_id == '569':
                        tf_layers_dict[layer_id] = tf.squeeze(tf.gather(
                            tf_layers_dict[get_tf_edges_from(tf_edges, layer_id, 0)],
                            temp,
                            axis=axis,
                            batch_dims=batch_dims
                ...
                print(f'@@@@@ axis: {axis}')
                print(f'@@@@@ axibatch_dimss: {batch_dims}')
                print(f'@@@@@ Gather layer_id:{layer_id} tf_layers_dict: {tf_layers_dict[layer_id]}')
            ...
            ### Reshape - TODO
                ...
                print(f'@@@@@@@@@@@ reshape layer_id:{layer_id} tf_layers_dict: {tf_layers_dict[layer_id]}')
